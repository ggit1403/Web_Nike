...
var saleCheckbox = document.getElementById("sale-checkbox")
...
var input4 = document.querySelector(".min_5M")
function max_1M(){
...
const contentLeftItemSale = document.querySelector('.content-left-item-sale');
const contentLeftItemSizing = document.querySelector('.content-left-item-sizing');
const contentLeftItemSize = document.querySelector('.content-left-item-size');
...
sale.addEventListener('click', function() {
    if (contentLeftItemSale.style.display === 'none') {
        contentLeftItemSale.style.display = 'block';
    } else {
        contentLeftItemSale.style.display = 'none';
    }
});
sizing.addEventListener('click', function() {
    if (contentLeftItemSizing.style.display === 'none') {
        contentLeftItemSizing.style.display = 'block';
    } else {
        contentLeftItemSizing.style.display = 'none';
    }
});
size.addEventListener('click', function() {
    if (contentLeftItemSize.style.display === 'none') {
        contentLeftItemSize.style.display = 'block';
    } else {
        contentLeftItemSize.style.display = 'none';
    }
});
