...
var black =  document.getElementById("black")
   black.addEventListener('click', function(){
        ...
        womenCheckbox.checked = false;
        menCheckbox.checked = false;
        outfit_1.checked = false;
        outfit_3.checked = false;
        outfit_4.checked = false;
        outfit_2.checked = false;
        sports_2.checked = false;
        sports_1.checked = false;
        sports_3.checked = false;
        sports_4.checked = false;
        features_2.checked = false; 
        features_3.checked = false; 
        features_1.checked = false; 
        features_4.checked = false; 
        benefits.checked = false; 
        material.checked = false;
        outfit2.checked = false;
        outfit3.checked = false;
        outfit1.checked = false;
    })
